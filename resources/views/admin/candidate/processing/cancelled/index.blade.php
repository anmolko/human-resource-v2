...
@section('title') Cancelled Candidate @endsection
@section('css')
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="page-title">Cancelled Candidate List</h3>
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">
                            <span class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item active text-white disabled" href="{{route('cancelled-candidate.index')}}" >Cancelled Candidates</a>
                                </div>
                            </span>
