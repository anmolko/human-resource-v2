        ...
        <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title">Reference Informaton</h3>
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('reference-info.index')}}">Reference Informaton</a></li>
                                <li class="breadcrumb-item active">Reference Informaton Trash</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="table-responsive">
                            ...
                            <!-- Reference Informaton Table -->
                            <table id="reference_index" class="table table-striped custom-table mb-0 ">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                            ...
                                            <div class="flex-shrink-0 ms-4">
                                                <ul class="list-inline tasks-list-menu mb-0">
                                                    <li class="list-inline-item">
                                                        <a class="action-restore" href="#" hrm-restore-action="{{route('reference-info.restore',$trash->id)}}" data-toggle="modal" data-target="#restore_reference_information">
                                                            <i class="fa fa-refresh align-bottom me-2 text-muted"></i></a></li>

                                                    <li class="list-inline-item">
                                                        <a class="remove-item-btn action-per-delete" hrm-delete-per-action="{{route('reference-info.remove',$trash->id)}}">
            ...
            <!-- /Page Content -->
             ...
             <!-- Restore Reference Informaton Modal -->
             @include('admin.modals.reference_information.restore')
            <!-- /Restore Reference Informaton Modal -->
    ...
    e.preventDefault();
        ...
        swal({
            ...
            .done(function(response) {
                ...
                swal({
                    title: "Warning.",
                    text: "You need to Remove Assigned Candidate Entry",
                    type: "info",
                    showCancelButton: true,
                    closeOnConfirm: false,
                    showLoaderOnConfirm: true,
