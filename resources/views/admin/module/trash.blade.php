...
@section('content')
        ...
        <div class="content container-fluid">
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item action-restore" href="#"  hrm-restore-action="{{route('module.restore',$trash->id)}}" data-toggle="modal" data-target="#restore_module"><i class="fa fa-refresh m-r-5"></i> Restore</a>
                                                    <a class="dropdown-item action-per-delete" href="#"  hrm-delete-per-action="{{route('module.remove',$trash->id)}}"><i class="fa fa-trash-o m-r-5"></i> Delete </a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
            ...
            <!-- /Page Content -->
             ...
             <!-- Restore Module Modal -->
             @include('admin.modals.modules.restore')
            <!-- /Restore Module Modal -->
