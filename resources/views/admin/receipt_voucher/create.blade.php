...
@section('title') Create Receipt Voucher @endsection
@section('css')
    <style>
        .cal-icon{
            width:50%;
...
@section('content')
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row">
                <div class="col">
                    <h3 class="page-title">Create Receipt Voucher</h3>
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Create Receipt Voucher</li>
                    </ul>
                </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        {!! Form::open(['method'=>'post','route'=>'receipt-voucher.store','id'=>'receipt-entry-form','class'=>'needs-validation','novalidate'=>'']) !!}
                        <div class="row">
                            <div class="col-sm-6 m-b-20">
                                <div class="">
                                    <?php
                                    $ref = 'REC-'.str_pad(time() + 1, 8, "0", STR_PAD_LEFT); ?>
                        ...
                        <div class="submit-section">
                            <button class="btn btn-primary submit-btn" id="submit_receipt_entry">Save</button>
                        </div>
                        {!! Form::close() !!}
...
@section('js')
    <script type="text/javascript">
        ...
        /*
        * @description:   Validation in Receipt Voucher
        ...
        $('#submit_receipt_entry').on('click', function(e){
            ...
            if(isDup){
                ...
                $.ajax({
                    ...
                    type: "POST",
                    url: "{{ route('debit.check') }}",
                    data: {'debit_id':array_debit},
                    success: function(data) {
                        ...
                        if(data == 0){
                            swal({
                                title: 'Receipt Voucher Warning',
                                text: "Please include cash or bank in atleast one particulars of Debit.",
                                type: "info",
                                showCancelButton: true,
                                closeOnConfirm: false,
                                showLoaderOnConfirm: true,
