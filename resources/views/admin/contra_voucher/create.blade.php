...
@section('title') Create Contra Voucher @endsection
@section('css')
    <style>
        .cal-icon{
            width:50%;
...
@section('content')
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row">
                <div class="col">
                    <h3 class="page-title">Create Contra Voucher</h3>
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Create Contra Voucher</li>
                    </ul>
                </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        {!! Form::open(['method'=>'post','route'=>'contra-voucher.store','id'=>'contra-entry-form','class'=>'needs-validation','novalidate'=>'']) !!}
                        <div class="row">
                            <div class="col-sm-6 m-b-20">
                                <div class="">
                                    <?php
                                    $ref = 'CON-'.str_pad(time() + 1, 8, "0", STR_PAD_LEFT); ?>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-white contra-entries">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select  class="custom-select form-control" name="account_title[]"  style="width: 300px" id="account_title" required>
                                    ...
                                    <td>
                                        <input class="form-control" style="min-width:100px" name="credit_amount[]" type="number" id="cr-amt" placeholder="0.00" required>
                                        <div class="invalid-feedback">
                        ...
                        <div class="submit-section">
                            <button class="btn btn-primary submit-btn" id="submit_contra_entry">Save</button>
                        </div>
                        {!! Form::close() !!}
...
@section('js')
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("select[name='account_title[]']").on('change',function(){
                var value = $(this).val();
                $.ajax({
                    headers: {
                    ...
                    type: "POST",
                    url: "{{ route('bank.check') }}",
                    data: {'value':value},
                    success: function(data) {
                        if(data == 0){
                            $('#narration').text("");
                        }else{
                            $('#narration').text("Cheque Number: ");
                        }
                    },
                    error: function() {
                        swal({
                            title: 'Contra Voucher Warning',
                            text: "Error. Could not confirm the status of the bank.",
                            type: "info",
        ...
        /*
        * @description:   Validation in Contra Voucher
        ...
        */
        ...
        $('#submit_contra_entry').on('click', function(e){
            ...
            $("select[name='drcr[]']").each(function() {
                value = $(this).val();
                if(value == 1){
                    var debit_id   = $(this).closest('tr').find("td select[name='account_title[]']").val();
                    array_debit.push(debit_id);
                }
            });
