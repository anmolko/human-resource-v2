<div id="edit_insurance_agent" class="modal custom-modal fade" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            {!! Form::open(['method'=>'PUT','class'=>'needs-validation updateinsuranceagent','novalidate'=>'','enctype'=>'multipart/form-data']) !!}

                <div class="form-group">
                    <label>Company Name <span class="text-danger">*</span></label>
                    <input class="form-control updatecompanyname" id="company_name" name="company_name" type="text" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control updatecompanyaddress" id="company_address" name="company_address" type="text" required>
                    <div class="invalid-feedback">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control updatecompanycontact" id="company_contact_num" name="company_contact_num" type="number" required>
                            <div class="invalid-feedback">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control updatecompanyemail" id="company_email" name="company_email" type="email" required>
                            <div class="invalid-feedback">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control updatefullname" id="fullname" name="personal_fullname" type="text">
                    <div class="invalid-feedback">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control updatedesignation" id="designation" name="personal_designation" type="text">
                            <div class="invalid-feedback">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control updateemail" id="personal_email" name="personal_email" type="email">
                            <div class="invalid-feedback">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control updatemobile" id="personal_mobile" name="personal_mobile_num" type="number">
                            <div class="invalid-feedback">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control updatecontact" id="personal_contact_num" name="personal_contact_num" type="number">
                            <div class="invalid-feedback">
