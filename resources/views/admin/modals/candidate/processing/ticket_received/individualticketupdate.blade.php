<div id="edit_individual_ticketing" class="modal custom-modal fade" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                {!! Form::open(['method'=>'PUT','class'=>'needs-validation updateindividual','novalidate'=>'']) !!}
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="ticket_no" id="ticket_no_update" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select country select-height" name="ticketing_agent_id" id="ticketing_agent_update" >
                                        <option value disabled > Select ticketing agent company. </option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select select-height" name="airline_id" id="airline_id_update">
                                        <option value disabled > Select airline ref no </option>
                                        @foreach($airline_detail as $airline)
                                            <option value="{{$airline->id}}">{{ucwords($airline->reference_no)}} </option>
                                        @endforeach
                                    </select>
                                    <div class="invalid-feedback">
                                        Please select a airline ref number.
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control booking_date" name="booking_date" id="booking_date_update">
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="booking_time" id="booking_time_update">
                                    <div class="invalid-feedback">
                                        Please select the Booking Date.
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control" rows="3" name="booking_description" id="booking_description_update"></textarea>
                                    <div class="invalid-feedback">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control visa_issued_date" name="status_applied_date" id="status_applied_date_update" required>
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select country select-height" name="sub_status_id" id="sub_status_update" required>
                                ...
                                <div class="form-group">
                                    <label>Remarks: </label>
                                    <textarea type="text" class="form-control" rows="2" name="remarks" id="remarks_update"></textarea>
                                    <div class="invalid-feedback">
                ...
                <div class="submit-section">
                    <button class="btn btn-primary submit-btn" id="submit-selected-candidate-form">Update</button>
                </div>
                {!! Form::close() !!}
            </div>
        </div>
