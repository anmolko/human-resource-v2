<div id="selected_to_underprocess" class="modal custom-modal fade" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"> Change Selected to Under Process</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                {!! Form::open(['method'=>'PUT','class'=>'needs-validation updateapplied','novalidate'=>'']) !!}
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <input type="hidden" name="candidate_personal_information_id" id="candidate_personal_information_id" />
                                ...
                                <div class="form-group">
                                    <label>Remarks: </label>
                                    <textarea type="text" class="form-control" rows="2" name="remarks" id="selected_remarks"></textarea>
                                    <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control demand-applied-date" name="status_applied_date" id="selected_status_applied_date" required>
                                            <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select country select-height demand-company-name" name="demand_info_id" id="selected_demand_info_id">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select job_to_demand_cat select-height" name="job_to_demand_id" id="selected_job_to_demand_id">
