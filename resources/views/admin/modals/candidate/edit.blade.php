    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                {!! Form::open(['method'=>'PUT','class'=>'updatecandidatepersonal submit_form','enctype'=>'multipart/form-data']) !!}
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control update_expiry_date" name="expiry_date" id="edit-expiredatetimepicker">
                                            <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select select2" name="reference_information_id" id="reference_information_id" >
...
{{--                                </div>--}}
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select select2" name="martial_status" id="martial_status" data-id="edits">
                                ...
                                <div class="row" id="martial_status_details">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Spouse: </label>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" min="1" class="form-control" name="height" id="height"/>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Weight: </label>
                                            <div class="input-group">
                                                <input type="text" min="1" class="form-control" name="weight" id="weight" />
                                                <div class="input-group-append">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            {!! Form::select('nationality', ['nepali'=>'Nepali','indian'=>'Indian','pakistani'=>'Indian','pakistani'=>'Pakistani','malaysian'=>'Malaysian','japanese'=>'Japanese','american'=>'American','canadian'=>'Canadian'], 'nepali',['class'=>'custom-select mb-3 select2','id'=>'nationality']) !!}
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select select2" name="religion" id="religion">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            {!! Form::select('province', $provinces, null,['class'=>'custom-select mb-3 select2','id'=>'province','placeholder'=>'Select Province','data-id'=>'index']) !!}
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            {!! Form::select('district', [], null,['class'=>'custom-select mb-3 select2','placeholder'=>'Select District','id'=>'district']) !!}
                                            <div class="invalid-feedback">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title mb-0">Education Information</h4>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="school_college_name" id="school_college_name" >
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select select-height" name="academic_level" id="academic_level">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control datepicker-completed-on" name="completed_on" id="completed_on">
                                            <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select select-height" name="division" id="division" >
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Result: </label>
                                            <select class="custom-select select-height" name="result" id="result">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" class="form-control" name="qualification_id" id="qualification_id" readonly>
                                            <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="select" name="kin_relationship" id="kin_relationship">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select select2" name="candidate_type" id="candidate_type">
