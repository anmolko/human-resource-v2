<div id="add_job_demand" class="modal custom-modal fade" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                {!! Form::open(['route' => 'job-to-demand.store','method'=>'post','class'=>'needs-validation','novalidate'=>'']) !!}
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            @if($errors->has('demand_information_id'))
                                <div class="invalid-feedback">
                                    {{$errors->first('demand_information_id')}}
                                </div>
                            @endif
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control select-company" name="company_name" id="company-name-map" type="text" readonly>
                            <div class="invalid-feedback">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control select-client-name" name="client_name" id="client-name-map" type="text" readonly>
                            <div class="invalid-feedback">
                                Please enter Company Name.
                            </div>
                            @if($errors->has('company_name'))
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="number" min="0" class="form-control" name="overtime_per_month"  />
                                <div class="input-group-append">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" name="levy"> Yes
                                </label>
                            </div>
                            <div class="invalid-feedback">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" min="0" value="0" name="levy_amount" type="number">
                            <div class="invalid-feedback">
