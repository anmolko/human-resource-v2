<div id="edit_advertising_agent" class="modal custom-modal fade" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                {!! Form::open(['method'=>'PUT','class'=>'needs-validation updateadvertisingagent','novalidate'=>'']) !!}

                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>Registration No <span class="text-danger">*</span></label>
                            <input class="form-control" name="registration_no" id="registration_no" type="text" required>
                ...
                <div class="submit-section">
                    <button class="btn btn-primary submit-btn" id="update-advertising-agent">Update</button>
                </div>
                {!! Form::close() !!}
            </div>
        </div>
