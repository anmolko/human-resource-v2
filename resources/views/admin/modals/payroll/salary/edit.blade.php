<div id="edit_employee_payroll" class="modal custom-modal fade" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Edit Advertising Agent</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                {!! Form::open(['method'=>'PUT','class'=>'needs-validation updateemployeepayroll','id'=>'employee_edit_payroll','novalidate'=>'']) !!}
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <select class="custom-select select-height" name="employee_type" id="employee_type" required>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="basic_salary" id="basic_salary" type="number" required>
                            <div class="invalid-feedback">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="provident_fund_contribution" id="provident_fund_contribution" type="number">
                    <div class="invalid-feedback">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="house_rent_allowance" id="house_rent_allowance" type="number">
                            <div class="invalid-feedback">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="medical_allowance" id="medical_allowance" type="number">
                            <div class="invalid-feedback">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="special_allowance" id="special_allowance" type="number">
                            <div class="invalid-feedback">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="other_allowance" id="other_allowance" type="number">
                            <div class="invalid-feedback">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="tax_deduction" id="tax_deduction" type="number">
                    <div class="invalid-feedback">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="provident_fund_deduction" id="provident_fund_deduction" type="number">
                            <div class="invalid-feedback">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="other_deduction" id="other_deduction" type="number">
                            <div class="invalid-feedback">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="total_provident_fund" id="total_provident_fund" value="0" type="number" readonly>
                    <div class="invalid-feedback">
                        Please enter the provident fund deduction.
                    </div>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="gross_salary" id="gross_salary" value="0" type="number" readonly>
                    <div class="invalid-feedback">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="total_deductions" id="total_deductions" value="0" type="number" disabled>
                </div>

                <div class="form-group">
                    <label>Net Salary</label>
                    <input class="form-control" name="net_salary" id="net_salary" value="0" type="number" readonly>
                    <div class="invalid-feedback">
                ...
                <div class="submit-section">
                    <button class="btn btn-primary submit-btn" id="update-employee-payroll">Update</button>
                </div>
                {!! Form::close() !!}
            </div>
        </div>
