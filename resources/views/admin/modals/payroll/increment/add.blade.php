<div id="add_increment" class="modal custom-modal fade" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
        <div class="modal-content">
            ...
            {!! Form::open(['route' => 'increment.store','method'=>'post','class'=>'needs-validation','novalidate'=>'','enctype'=>'multipart/form-data']) !!}
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="cal-icon">
                                <input class="form-control floating" id="datetimepickermonthincrement" name="month" type="text" required>
