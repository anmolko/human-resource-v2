<div id="add_counsellor" class="modal custom-modal fade" role="dialog">
    <div class="modal-dialog modal-dialog-centered " role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                {!! Form::open(['route' => 'counsellor.store','method'=>'post','class'=>'needs-validation','novalidate'=>'']) !!}
                    
                    <div class="form-group">
                        <label >Caller Name <span class="text-danger">*</span></label>
                        <select class="custom-select" name="overseas_agent_id" id="overseas_agent_id" required>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="response" id="response" rows="2" required></textarea>
                        <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                        <label>Misc </label>
                        <textarea class="form-control" name="misc" id="misc" rows="2" ></textarea>
                        <div class="invalid-feedback">
                            Please enter a misc.
                        </div>
                        @if($errors->has('misc'))
