    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Add Company Information</h5>
            ...
            <div class="modal-body">
                ...
                {!! Form::open(['route' => 'company.store','method'=>'post','class'=>'needs-validation','novalidate'=>'','enctype'=>'multipart/form-data']) !!}
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            {!! Form::select('overseas_agent_id', $agents, null,['class'=>'custom-select mb-3 select2','placeholder'=>'Select overseas agent']) !!}
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <select class="custom-select select2" name="country" id="addcountry">
