<div id="edit_file" class="modal custom-modal fade" role="dialog">
    <div class="modal-dialog modal-dialog-centered " role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                {!! Form::open(['method'=>'PUT','class'=>'needs-validation updatefile','novalidate'=>'','enctype'=>'multipart/form-data']) !!}
