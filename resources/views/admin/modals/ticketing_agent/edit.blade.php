<div id="edit_ticketing_agent" class="modal custom-modal fade" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Edit Ticketing Agent</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                {!! Form::open(['method'=>'PUT','class'=>'needs-validation updateticketingagent','novalidate'=>'']) !!}

                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>Agent ID <span class="text-danger">*</span></label>
                            <input class="form-control" name="agent_id" id="agent_id" type="text" required>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control"  name="contact" id="contact" type="number">
                            <div class="invalid-feedback">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="postal_address" id="postal_address" type="text" >
                            <div class="invalid-feedback">
                    ...
                    @foreach($airlines as $airline)
                        <div class="col-md-3 col-6 text-center ">
                            <label class="select-label">
                                <input type="checkbox" value="{{$airline->id}}" name="airline_detail_id[]" id="airline_detail_ids[]">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="personal_contact" id="personal_contact" type="number">
                            <div class="invalid-feedback">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="personal_mobile" id="personal_mobile" type="number">
                            <div class="invalid-feedback">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="personal_email" id="personal_email" type="email">
                ...
                <div class="submit-section">
                    <button class="btn btn-primary submit-btn" id="update-ticketing-agent">Update</button>
                </div>
                {!! Form::close() !!}
            </div>
        </div>
