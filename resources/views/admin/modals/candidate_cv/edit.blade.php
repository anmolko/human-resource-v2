<div id="edit_candidate_cv" class="modal custom-modal fade" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Edit CV Info for Candidate</h5>
            ...
            <div class="modal-body">
                ...
                {!! Form::open(['method'=>'PUT','class'=>'needs-validation updatecandidatecv','novalidate'=>'']) !!}


                <div class="form-group">
                    <label >Candidate Name <span class="text-danger">*</span></label>
                    <select class="custom-select updatecandidate" name="candidate_personal_information_id" id="candidate_personal_information_id" required>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <textarea class="form-control updateprofile" name="profile" id="profile" rows="4" required></textarea>
                            <div class="invalid-feedback">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <textarea class="form-control updatedeclaration" name="declaration" id="declaration" rows="4" required></textarea>
                            <div class="invalid-feedback">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <textarea class="form-control updateskill" name="skill" id="skill" rows="4" required></textarea>
                            <div class="invalid-feedback">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control updateduty" name="duty" id="duty" rows="4" required></textarea>
                            <div class="invalid-feedback">
                                Please enter a duty.
                            </div>
                            @if($errors->has('duty'))
