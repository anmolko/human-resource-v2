        ...
        <div class="modal-content">
            ...
            {!! Form::open(['method'=>'PUT','class'=>'needs-validation updateoverseas','novalidate'=>'','enctype'=>'multipart/form-data']) !!}
                ...
                <div class="form-group">
                    ...
                    <label>
                        {!! Form::radio('type_of_company', 'company', true,['class'=>'type_of_company']) !!}
                        Company
                    </label>&nbsp;&nbsp;
                    <label>
                        {!! Form::radio('type_of_company', 'individual',false,['class'=>'type_of_company']) !!}
                        Individual
                    </label>
                </div>
                ...
                <div id="company-information">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control edit-require" id="company_name" name="company_name" type="text" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="row" id="country-group-company">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="col-form-label">Country </label>
                                <select class="custom-select updatecountry" name="country" id="editcountry" data-id="company-edits">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control edit-require" id="company_email" name="company_email" type="email" required>
                                <div class="invalid-feedback">
                ...
                <div class="personal-information">
                    ...
                    <div class="row" id="country-group-personal">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="col-form-label">Country </label>
                                <select class="custom-select select2 updatepersonalcountry" name="country_personal" id="country2" data-id="personal-edits">
                                    <option value disabled selected> Select Country</option>
                                    @foreach($countries as $key => $value)
                                        <option value="{{$key}}">{{ucwords($value)}} </option>
                                    @endforeach
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="col-form-label">State </label>
                                <select class="custom-select select2" name="state_personal" id="state2">
                                    <option value disabled selected> Select State</option>
