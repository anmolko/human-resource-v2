        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <select class="custom-select" name="overseas_agent_id" required>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="fax_no" type="number" required>
                            <div class="invalid-feedback">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <select class="custom-select select-height" name="category" required>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="datetimepicker" name="fulfill_date" type="text" required>
                            <div class="invalid-feedback">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="datetimepicker1" name="issued_date" type="text" required>
                            <div class="invalid-feedback">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="datetimepicker2" name="expired_date" type="text" required>
                            <div class="invalid-feedback">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <select class="custom-select select-height" name="advertised" required>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="doc_status" type="text" required>
                            <div class="invalid-feedback">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="num_of_pax" type="number" required>
                            <div class="invalid-feedback">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control"  id="datetimepicker3" name="doc_received_date" type="text" required>
                            <div class="invalid-feedback">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="doc_status_remarks" rows="4" required=""></textarea>
                    <div class="invalid-feedback">
