...
@section('content')
            ...
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('health-clinic.index')}}">Health Clinic</a></li>
                        <li class="breadcrumb-item active">Health Clinic Trash</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="table-responsive">
                    ...
                    <!-- Health Clinic Trash Table -->
                    <table id="health_clinic" class="table table-striped custom-table mb-0 ">
                        <thead>
                        <tr>
                            <th>Name</th>
                            <th>Address</th>
                                    ...
                                    <div class="flex-shrink-0 ms-4">
                                        <ul class="list-inline tasks-list-menu mb-0">
                                            <li class="list-inline-item">
                                                <a class="action-restore" href="#" hrm-restore-action="{{route('health-clinic.restore',$trash->id)}}" data-toggle="modal" data-target="#restore_health_clinic">
                                                    <i class="fa fa-refresh align-bottom me-2 text-muted"></i></a></li>

                                            <li class="list-inline-item">
                                                <a class="remove-item-btn action-per-delete" href="#" hrm-delete-per-action="{{route('health-clinic.remove',$trash->id)}}">
    ...
    <!-- Restore Health Clinic Modal -->
    @include('admin.modals.health_clinic.restore')
    <!-- /Restore Health Clinic Modal -->
