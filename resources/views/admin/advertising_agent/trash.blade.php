...
@section('content')
            ...
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('advertising-agent.index')}}">Advertising Agent</a></li>
                        <li class="breadcrumb-item active">Advertising Agent Trash</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="table-responsive">
                    ...
                    <!-- Advertising Agent Trash Table -->
                    <table id="advertising_agent" class="table table-striped custom-table mb-0 ">
                        <thead>
                        <tr>
                            <th>#</th>
                                ...
                                <td class="text-right">
                                    <div class="dropdown dropdown-action">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item action-restore" href="#"  hrm-restore-action="{{route('advertising-agent.restore',$trash->id)}}" data-toggle="modal" data-target="#restore_advertising_agent"><i class="fa fa-refresh m-r-5"></i> Restore</a>
                                            <a class="dropdown-item action-per-delete" href="#"  hrm-delete-per-action="{{route('advertising-agent.remove',$trash->id)}}" ><i class="fa fa-trash-o m-r-5"></i> Delete </a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
    ...
    @include('admin.modals.advertising_agent.restore')
    <!-- /Restore Advertising Agent Modal -->
