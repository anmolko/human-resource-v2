                    ...
                    <div class="row align-items-center">
                        <div class="col">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Overseas Agent Trash</li>
                            </ul>
                        </div>
                    </div>
                </div>
...
{{--                                            </div>--}}
                                            ...
                                            <div class="flex-shrink-0 ms-4">
                                                <ul class="list-inline tasks-list-menu mb-0">
                                                    <li class="list-inline-item">
                                                        <a class="action-restore" href="#" hrm-restore-action="{{route('overseas-agent.restore',$trash->id)}}" data-toggle="modal" data-target="#restore_overseas_agent">
                                                            <i class="fa fa-refresh align-bottom me-2 text-muted"></i></a></li>

                                                    <li class="list-inline-item">
                                                        <a class="remove-item-btn action-per-delete" hrm-delete-per-action="{{route('overseas-agent.remove',$trash->id)}}">
            ...
            <!-- /Page Content -->
             ...
             @include('admin.modals.overseas_agent.restore')
            <!-- /Restore Overseas Agent Modal -->
