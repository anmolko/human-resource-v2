...
@section('title') Journal Entry @endsection
@section('css')
<style>
    td.details-controls {
        text-align:center;
...
@section('content')
        ...
        <div class="content container-fluid">
                    ...
                    <div class="row align-items-center">
                        <div class="col">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Journal Entry Trash</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="table-responsive">
                            ...
                            <!-- Journal Entry Table -->
                            <table id="journal_entry" class="table table-striped custom-table mb-0 ">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>Date</th>
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item action-restore" href="#"  hrm-restore-action="{{route('journal-entry.restore',$trash->id)}}" data-toggle="modal" data-target="#restore_journal_entry"><i class="fa fa-refresh m-r-5"></i> Restore</a>
                                                    <a class="dropdown-item action-per-delete" href="#"  hrm-delete-per-action="{{route('journal-entry.remove',$trash->id)}}" ><i class="fa fa-trash-o m-r-5"></i> Delete </a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
            ...
            <!-- /Page Content -->
             ...
             <!-- Restore Journal Entry Modal -->
             @include('admin.modals.journal_entries.restore')
            <!-- /Restore Journal Entry Modal -->
...
<script type="text/javascript">
       $(document).ready(function () {
            ...
            $.each(mainvalue.journal_particulars_trash, function( index, value ) {
            ...
            $('#journal_entry tbody').off('click', 'td.details-control');
            $('#journal_entry tbody').on('click', 'td.details-control', function () {
        ...
        $(document).on('click','.action-per-delete', function (e) {
            ...
            swal({
                ...
                .done(function(response) {
                    ...
                    swal({
                        title: "Error!",
                        text: "Failed to delete journal particulars from trash",
                        type: "error",
                        showCancelButton: true,
                        closeOnConfirm: false,
                        showLoaderOnConfirm: true,
