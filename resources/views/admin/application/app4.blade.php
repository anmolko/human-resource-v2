...
@section('css')
    <link rel="stylesheet" href="{{asset('/backend/assets/print4.css')}}"/>
@endsection
                        ...
                        <li class="breadcrumb-item active">
                            <span class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item" href="/candidate-personal-application/{{$candidate_personal->id}}/app3">Dynamic Application(Custom Letterhead)</a>
                                    <a class="dropdown-item active text-white disabled">Employment Application 4</a>
                                </div>
                            </span>
                        </li>
                    </ul>
        ...
        <div class="cv-base" >
            <page id="printable_div" class="front">
                <header class="print-header">
                    <div class="head-top">
                        <img src="{{asset('/images/frame4.png')}}" style="width:100%;"/>
                    </div>
                    ...
                    <div class="head-bottom">
                        <div class="margin">
                            <div class="image-left">
                                <img src="{{asset('/images/company/'.@$company_data->company_logo)}}" width="50%"/>
                            </div>
                ...
                <section class="print-body">
                    ...
                    <div class="body-margin">
                        ...
                        <div class="row g-5 mt-2 ml-1 mb-2">
                            <h4 class="mb-0 mt-0">QUALIFICATION DETAILS</h4>
                            ...
                            <h4 class="mb-1  mt-0">WORK HISTORY </h4>
                            <div class="col-md-12 col-lg-12">
                                <div class="form-group row mb-0 mr-2">
                                    <table class="table table-sm table-bordered">
                                        <thead>
                        ...
                        <div class="row g-5 mb-1 mt-0 p-2">
                            <div class="col-6">
                                     <span class="float-left text-center">
                                        ...
                                        <label class="mt-2">Interviewer's signature</label>
                                     </span>
                            </div>
                            <div class="col-6">
...
@section('js')
    <script>
        $('#print-button').on('click',function(){
            ...
            var stylename    = '<link rel="stylesheet" href="/backend/assets/print4.css" type="text/css">';
