...
@section('css')
    <link rel="stylesheet" href="{{asset('/backend/assets/print2.css')}}"/>
@endsection
                        ...
                        <li class="breadcrumb-item active">
                            <span class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item active text-white disabled">Employment Application 2</a>
                                    <a class="dropdown-item action-application" href="/candidate-personal-application/{{$candidate_personal->id}}/app3" >Dynamic Application(Custom Letterhead)</a>
                    ...
                    <div class="body-margin">
                        ...
                        <div class="row g-5">
                            ...
                            <div class="col-md-3 col-lg-2">
                                ...
                                @else
                                    <img src="{{asset('/images/document/'.@$candidate_personal->documentInfo[0]->photograph_image)}}" class="mt-3 mb-3" height="210px" width="auto"/>
                                @endif
