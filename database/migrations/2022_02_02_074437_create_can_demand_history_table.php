...
class CreateCanDemandHistoryTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('can_demand_history', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->string('receivable_salary')->nullable();
    ...
    {
        Schema::dropIfExists('can_demand_history');
    }
}
