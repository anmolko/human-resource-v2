...
class CreatePaymentvoucherParticularsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('paymentvoucher_particulars', function (Blueprint $table) {
            ...
            $table->foreign('payment_voucher_id')->references('id')->on('payment_vouchers')->onUpdate('cascade')->onDelete('cascade');
            $table->softDeletes();
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('paymentvoucher_particulars');
    }
}
